...
grep -q 'AGENT_HARNESS_AGY_ALLOW_YOLO=1' "$TMP/.agents/skills/repository-orchestrator/SKILL.md"
...
grep -q 'agy host jobs may run only inside orchestrator task/review worktrees' "$ROOT/scripts/orchestrator/agy-client.mjs"
